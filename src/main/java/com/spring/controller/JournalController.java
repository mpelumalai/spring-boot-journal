...
public class JournalController {
	...
	static  {
		try {
			entries.add(new JournalEntry("Get to know Spring Boot","Today I will learn Spring Boot","01-02-2016"));
			entries.add(new JournalEntry("Simple Spring Boot Project","I will do my first Spring Boot Project","17-01-2017"));
			entries.add(new JournalEntry("Spring Boot Reading","Read more about Spring Boot","20-02-2015"));
			entries.add(new JournalEntry("Spring Boot in the Cloud","Spring Boot using Cloud Foundry","03-01-2017"));
